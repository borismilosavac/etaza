...
* [1. Domen i ciljevi](#1-domen-i-ciljevi)
* [2. Glosar (kanonska terminologija)](#2-glosar-kanonska-terminologija)
* [3. Informaciona arhitektura (IA)](#3-informaciona-arhitektura-ia)
* [4. UX tokovi (state machine definicije)](#4-ux-tokovi-state-machine-definicije)
* [5. UI specifikacija (komponente + props)](#5-ui-specifikacija-komponente--props)
* [6. Validacije i greške (normativ)](#6-validacije-i-greške-normativ)
* [7. Freemium vs Premium (egzekutivni rezime)](#7-freemium-vs-premium-egzekutivni-rezime)
* [8. Notifikacije i kanali](#8-notifikacije-i-kanali)
* [9. Privatnost, sigurnost, compliance](#9-privatnost-sigurnost-compliance)
...
* [12. Plan switch (Freemium ↔ Plus)](#12-plan-switch-freemium--plus)
* [13. Pristupačnost (kontrolna lista)](#13-pristupačnost-kontrolna-lista)
* [14. Performanse i offline](#14-performanse-i-offline)
* [15. Analitika (eventi i KPI)](#15-analitika-eventi-i-kpi)
* [16. QA scenariji (prihvatni kriterijumi)](#16-qa-scenariji-prihvatni-kriterijumi)
* [17. Figma artefakti (obavezno)](#17-figma-artefakti-obavezno)
* [18. Tekstualni standard (microcopy)](#18-tekstualni-standard-microcopy)
* [19. Flutter implementacija — smjernice za razvoj](#19-flutter-implementacija--smjernice-za-razvoj)
